...
public class HeartController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        randomElementPositionY.Add(30);
        randomElementPositionY.Add(60);
        ...
        this.transform.position = new Vector3(randomElementPositionX[Random.Range(0, 3)], this.transform.position.y + randomElementPositionY[Random.Range(0, 2)], this.transform.position.z);
        ...
        rightwall.transform.position = new Vector3(this.transform.position.x, this.transform.position.y - 0.1f, rightwall.transform.position.z);
    }
    ...
    public void MoveObject()
    {
        ...
        gameObject.GetComponent<SpriteRenderer>().sprite = can;
        gameObject.transform.localScale = new Vector3(0.5705792f, 0.5705792f, 0.5705792f);
    }
    ...
    void FixedUpdate()
    {
        ...
        if (playerController.GodMode == true)
        {
          ...
          //  this.transform.position.x = Mathf.Sin(Time.time * 1.0f);
        }
